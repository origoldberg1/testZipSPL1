...
class AddCustomer : public Action {
    public:
        AddCustomer(string customerName, string customerTypeVar, int distance, int maxOrders);
        void act(WareHouse &wareHouse) override;
        AddCustomer *clone() const override;
        string toString() const override;
        CustomerType stringToEnumCT(string customerType) const;
        string enumToStringCT() const;
